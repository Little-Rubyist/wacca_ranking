class SongsController < ApplicationController
  def index
    ...
    songs = searched_songs.select('songs.music_id as music_id,MAX(songs.title_english) as title_english, MAX(songs.title) as title, MAX(songs.genre) as genre, MAX(songs.can_play_offline) as can_play_offline').group(:music_id)
